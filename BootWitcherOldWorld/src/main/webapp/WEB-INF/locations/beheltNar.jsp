...
<body>
    ...
    <div class="collapse" id="locationButtons">
        <form action="changeLocation.do">
            ...
            <button type="submit" class="btn btn-secondary">Go To Vengerberg</button>
        </form>
        <form action="changeLocation.do">
            <input type="hidden" name="locationId" value="15">
            <button type="submit" class="btn btn-secondary">Go To Gorthur Guaed</button>
        </form>
        <form action="changeLocation.do">
            <input type="hidden" name="locationId" value="11">
            <button type="submit" class="btn btn-secondary">Go To Beauclair</button>
        </form>
        <form action="changeLocation.do">
            <input type="hidden" name="locationId" value="8">
            <button type="submit" class="btn btn-secondary">Go To Ban Ard</button>
        </form>
    </div>
</div>
