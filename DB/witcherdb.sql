...
INSERT INTO `monster` (`id`, `name`, `description`, `health`, `damage`, `experience_reward`, `image_url`, `player_id`) VALUES (3, 'Harpy', 'Atop towering cliffs and rocky outcrops overlooking the restless sea, the Harpies make their nest. With their piercing cries and razor-sharp talons, they swoop down upon unsuspecting sailors and travelers who dare to pass too close to their domain. Legends speak of their hypnotic beauty, luring sailors to their doom with promises of forbidden treasures hidden within their nests.', 12, 3, 1, 'https://cdnb.artstation.com/p/assets/images/images/004/985/527/medium/bartlomiej-gawel-celaeno-harpy.jpg?1487675385', NULL);
INSERT INTO `monster` (`id`, `name`, `description`, `health`, `damage`, `experience_reward`, `image_url`, `player_id`) VALUES (4, 'Manticore', 'In the arid deserts and barren wastelands, where the scorching sun beats down relentlessly, the Manticore reigns supreme. With its lion-like body, bat-like wings, and venomous tail, it is the apex predator of the desert. Tales are told of its cunning and intelligence, ambushing travelers and caravans with deadly precision before feasting upon their remains.', 14, 4, 2, 'https://as2.ftcdn.net/v2/jpg/06/42/23/57/1000_F_642235722_8trsP2SmXiigFX9pDZ9MzfewgTqP0HQN.jpg', NULL);
