...
INSERT INTO `location` (`id`, `name`, `description`, `image_url`) VALUES (4, 'Cidaris', 'Nestled along the coast, Cidaris is a picturesque town known for its maritime trade and beautiful landscapes. Famous for its shipyards and seafaring tradition, Cidaris is a vital maritime center in the Witcher world.', 'https://static.wikia.nocookie.net/witcher/images/2/29/Netflix_cintra.jpeg/revision/latest/scale-to-width-down/1000?cb=20191212190120');
INSERT INTO `location` (`id`, `name`, `description`, `image_url`) VALUES (5, 'Cintra', 'Once a grand kingdom with a rich history, Cintra is now a land scarred by conflict. Known for its valiant warriors and resilient spirit, the town has faced adversity but remains a symbol of strength and determination.', 'https://static.wikia.nocookie.net/witcher/images/0/06/Netflix_concept_slaughter_of_cintra.jpg/revision/latest/scale-to-width-down/1000?cb=20200101185439');
